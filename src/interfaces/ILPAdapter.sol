...
interface ILPAdapter {
    /**
     * @notice 适配器类型
     * @param UNISWAP_V2 Uniswap V2
     * @param UNISWAP_V3_LOW_FEE Uniswap V3 0.05%费率池
     * @param UNISWAP_V3_HIGH_FEE Uniswap V3 0.30%费率池
     */
    enum AdapterType {
        UNISWAP_V2,
        UNISWAP_V3_LOW_FEE,
     ...
     * @param fees0 待领取手续费token0
     * @param fees1 待领取手续费token1
     */
     ...
     * @return liquidityId 流动性标识（V2为0，V3为position key hash）
     */
